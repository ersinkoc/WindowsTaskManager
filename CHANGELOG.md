...
### Fixed
- **Release Toolchain** — Updated the Go toolchain to 1.26.4 so the release vulnerability scan uses the patched standard library.

## [0.4.2] - 2026-06-20

### Fixed
- **WebView2 Content Scroll** — Made the main content area a bounded scroll viewport so mouse wheel scrolling works when the pointer is over page content.
